...
const Hero = () => {
	// var t1 = gsap.timeline({defaults:{duration: .7, ease: "none", opacity: 1}})
	// t1.from(".white-ball", {delay: 1, scale: .2, transformOrigin: 'center'}, "=.2")
	// .from(".blue-squiggle", {scaleY:0.5, transformOrigin: 'top'})
	...
	return (
		...
		<HeroSection>
			...
			<svg className="floating-icons" viewBox="0 0 827 708" fill="none" xmlns="http://www.w3.org/2000/svg">
				...
				<circle cx="301" cy="653" r="53.5" stroke="white" stroke-opacity="0.25" stroke-width="3"/>
				<path d="M38.1695 146.53L54.0873 55.2422L125.186 114.671L38.1695 146.53Z" stroke="white" stroke-opacity="0.25" stroke-width="3"/>
				<path d="M371.672 473.877L414.383 462.238L403.107 505.046L371.672 473.877Z" stroke="white" stroke-opacity="0.25" stroke-width="3"/>
				</g>
				<defs>
				<clipPath id="clip0">
